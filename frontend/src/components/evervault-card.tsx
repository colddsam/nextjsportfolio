...
import { CardStackDemo } from "@/components/QuizCard";
import { TailwindcssButtons } from "@/components/NextButton";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="relative z-10 flex flex-col  h-screen w-screen items-center justify-center">
          <div className="relative h-auto w-auto  flex flex-col items-center justify-center ">
            <CardStackDemo/>
            <TailwindcssButtons/>
          </div>
        </div>
