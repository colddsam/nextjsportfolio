...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "relative h-auto min-h-screen w-screen flex items-center bg-black justify-center group md:p-16 p-0",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block py-0 px-1 md:py-0 rounded-lg bg-gradient-to-r  from-indigo-500 to-purple-500`,
        className
      )}
    >
      {children}
