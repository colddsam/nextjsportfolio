...
export function AnimatedPinDemo() {
  ...
  return (
    <div className="h-full md:h-screen w-screen dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex p-4 flex-wrap items-center justify-center">
