...
export default function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center h-screen md:h-full relative w-full mt-10">
          <div className="max-w-7xl flex flex-col items-center justify-center mx-auto w-full relative overflow-hidden h-full md:h-screen px-4">
